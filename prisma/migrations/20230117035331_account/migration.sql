/*
  ...
  - You are about to drop the column `userId` on the `Nasin` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "Nasin" DROP CONSTRAINT "Nasin_userId_fkey";

-- DropIndex
DROP INDEX "User_discordId_key";

-- DropIndex
DROP INDEX "User_url_idx";

-- DropIndex
DROP INDEX "User_url_key";

-- AlterTable
ALTER TABLE "Nasin" DROP COLUMN "userId";
